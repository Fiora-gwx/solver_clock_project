...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--experiment-config", default="configs/ablation/experiments/ri_sadb_cifar10_smoke.yaml")
    parser.add_argument("--outputs-root", default="outputs")
    parser.add_argument("--metrics-root", default="outputs/ri_sadb_cifar10_smoke/metrics")
    parser.add_argument("--smoke-csv", default="outputs/ri_sadb_cifar10_smoke/metrics/ri_sadb_cifar10_smoke_status.csv")
